...
export const Heroes: Record<string, Hero> = {
  ...
  righteous_thief_roozid: new Hero({
    ...
    baseHP: 4370,
    baseDefense: 462,
    heroSpecific: ['casterSpeed', 'skillTreeCompleted'],
    skills: {
      s1: new Skill({
        id: 's1',
        speedScaling: true,
      ...
      s2: new Skill({
        ...
        rate: (soulburn: boolean) => soulburn ? 2.2 : 1.6,
        pow: () => 1,
        mult: (soulburn: boolean, inputValues: DamageFormData, artifact: Artifact) => inputValues.skillTreeCompleted ?  1.05 + inputValues.casterFinalSpeed() * 0.001125 : 1 + inputValues.casterFinalSpeed() * 0.001125,
        multTip: () => ({ casterSpeed: 0.1125 }),
        enhance: [0.05, 0.1, 0, 0, 0.15],
        isSingle: () => true,
      })
